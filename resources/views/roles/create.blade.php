                ...
                <div class="p-6">
                    <form action="{{ route('roles.store') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" class="w-full rounded-xl border-border bg-body text-primary focus:border-brand-blue focus:ring-brand-blue" required placeholder="Contoh: Manajer">
                            @error('name')
                        ...
                        <div class="mb-6">
                            <h3 class="text-sm font-medium text-primary mb-4 border-b border-border pb-2">Pilih Hak Akses (Permissions)</h3>
                            <div class="space-y-6">
