<button id="theme-toggle" type="button" class="text-secondary hover:text-primary focus:outline-none focus:ring-2 focus:ring-brand-blue rounded-lg text-sm p-2.5 transition-colors">
